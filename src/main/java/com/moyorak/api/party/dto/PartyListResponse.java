...
public record PartyListResponse(
        ...
        @Schema(
                        description = "파티 투표 종료 시간",
                        nullable = true,
                        example = "2025-08-08 12:05:00 or null(랜덥투표)")
                LocalDateTime endDate,
        @Schema(description = "파티 제목", example = "점심팟 모읍니다.") String title,
        @Schema(description = "파티 투표 타입", example = "SELECT", implementation = VoteType.class)
                VoteType voteType,
        @Schema(description = "파티 투표 진행 상태", example = "VOTING", implementation = VoteStatus.class)
